...
export const zh: Record<string, string> = {
  ...
  'hud.sound': 'Alt+M 静音',
  'hud.goldSeal': '金卡',
  'hud.roll': '掷签中…尾部对上才算抓到',
  'hud.rollpool': '签筒摇响，深海屏息|洋流推着签打转|鲸歌低语着一串数字|气泡排成一列卦象|万米深渊传来回响|签尖挑起一粒星沙',
  'hud.wrigpool': '鳞光一闪，它溜了|尾巴一甩，溅你一脸墨|差半寸，指尖只碰到水|它冲你吐了个泡泡',
  'hud.rollmine': '你的签尾',
  'hud.rolltarget': '目标',
  'hud.toosoon': '算力冷却中，稍后再试',
  'hud.toosoonwait': '刚抓到一张卡，约 {m} 分钟后再抓',
  'hud.steer': '🖱 爪子跟随鼠标，点击收爪',
  'card.chain': '链上凭证',
  'card.block': '铸造区块',
  'ocean.pacific': '太平洋',
  'ocean.atlantic': '大西洋',
...
export const en: Record<string, string> = {
  'shell.title': 'Deep-Sea Claw',
  'shell.open': 'Open Deep-Sea Claw',
  'shell.stick': 'Stick to edge',
  'shell.float': 'Float mode',
  'shell.minimize': 'Minimize',
  'shell.expand': 'Expand Deep-Sea Claw',
  ...
  'hud.touch': 'Touched!',
  'hud.grabbed': 'Got it! Generating card…',
  ...
  'hud.toosoonwait': 'just grabbed a card — next grab in ~{m} min',
  'hud.steer': '🖱 claw follows pointer — click to snap',
  'card.chain': 'on-chain proof',
  'card.block': 'mint block',
