/**
 * tsdown build for dsh-deepsea:
 *
 * - the host half: lib/index.js (ESM node) — the /deepsea JSON API + card asset
 *   proxy routes;
...
export default [
  ...
  clientBundle("dsh-deepsea", "client.js"),
  // Plugin-registry channel: bundle id = manifest id (dsh.plugin.json).
  clientBundle("dsh-external/dsh-deepsea", "client-registry.js"),
